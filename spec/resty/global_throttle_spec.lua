describe("global_throttle", function()
  ...
  describe("new", function()
    ...
    it("requires store param to have provider attribute defined", function()
      local my_throttle, err = global_throttle.new(100, 5, ngx.shared.decision_cache, {})
    ...
    it("returns global throttle instance for Lua shared dict backend store", function()
      local my_throttle, err = global_throttle.new(100, 5, ngx.shared.decision_cache, { provider = "shared_dict", name = "my_global_throttle" } )
  ...
  describe("process", function()
    describe("with Lua shared dict", function()
      ...
      before_each(function()
        local err
        my_throttle, err = global_throttle.new(10, 2, ngx.shared.decision_cache,
